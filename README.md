# Newstead Christian School Webflow Starter

This GitHub project provides a development workflow for JavaScript files in Newstead Christian School Webflow Starter.
...
1. The initial `entry.js` file needs to be made available via external server first for this system to work (in the `<head>` area of the site).
   ...
   ```html
   <script src="https://cdn.jsdelivr.net/gh/igniteagency/newstead-webflow-site/dist/prod/entry.js"></script>
   ```
